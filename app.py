...
TIPOS_PROGRAMA_PROGRAMAS = {
    ...
    "TSU": [
        "TSU EN EDUCACIÓN, MENCIÓN MATEMÁTICA",
        "TSU EN EDUCACIÓN, MENCIÓN FÍSICA",
        "TSU EN EDUCACIÓN, MENCIÓN QUÍMICA",
        "TSU EN EDUCACIÓN, MENCIÓN BIOLOGÍA",
        "TSU EN EDUCACIÓN, MENCIÓN MEMORIA, TERRITORIO Y CIUDADANÍA",
        "TSU EN EDUCACIÓN, MENCIÓN EDUCACIÓN FÍSICA",
        "TSU EN EDUCACIÓN, MENCIÓN INGLÉS",
        "TSU EN EDUCACIÓN, MENCIÓN EDUCACIÓN INICIAL",
        "TSU EN EDUCACIÓN, MENCIÓN LENGUA",
        "TSU EN EDUCACIÓN, MENCIÓN EDUCACIÓN PRIMARIA",
        "TSU EN EDUCACIÓN, MENCIÓN ADMINISTRACIÓN Y GESTIÓN ESCOLAR",
        "TSU EN EDUCACIÓN, MENCIÓN GESTIÓN Y MANTENIMIENTO DEL AMBIENTE ESCOLAR",
        "TSU EN EDUCACIÓN, MENCIÓN EDUCACIÓN DE JÓVENES, ADULTOS Y ADULTAS",
        "TSU EN EDUCACIÓN, MENCIÓN EDUCACIÓN ESPECIAL",
    ],
    "PNFA_E": [
...
# Mallas de las LICENCIATURAS (recorrido Bachiller) extraídas del formato oficial.
_MALLAS_BACHILLER = {
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN MATEMÁTICA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        (0, '', 'COHORTE', 3),
        (0, '', 'INGRESO o REINGRESO', 3),
        (0, '', 'NIVEL', 3),
        (0, '', 'Cédula de Identidad', 3),
        (0, '', 'Primer Nombre (como aparece en la cédula)', 3),
        (0, '', 'Segundo Nombre (como aparece en la cédula)', 3),
        (0, '', 'Primer Apellido (como aparece en la cédula)', 3),
        (0, '', 'Segundo Apellido (como aparece en la cédula)', 3),
        (0, '', 'Sexo', 3),
        (0, '', 'Número Celular', 3),
        (0, '', '¿Recibió formación presencialo multimodal?', 3),
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER SEMESTRE', 'Planificación y análisis de la práctica Docente. Nivel I.A', 3),
        (1, 'PRIMER SEMESTRE', 'Planificación y análisis de la práctica Docente. Nivel I.B', 3),
        (1, 'PRIMER SEMESTRE', 'Pensamiento Pedagogico liberador nuestroamericano', 3),
        (1, 'PRIMER SEMESTRE', 'Matemática y realidad.', 3),
        (1, 'PRIMER SEMESTRE', 'Cantidad y su didáctica.', 3),
        (1, 'PRIMER SEMESTRE', 'Uso racional de los recursos naturales y preservación del planeta I.', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Planificación y análisis de la Práctica Docente. Nivel II.', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Problematización en IAPT I.', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Formacion Ciudadana a la luz de la Constitucion Bolivariana de Venezuela', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Cambio I y su didáctica.', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Forma y dimensión I y su didáctica.', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Uso racional de los recursos naturales y preservación del planeta II.', 3),
        (3, 'TERCER SEMESTRE', 'Intervención fundamentada de la práctica docente. Nivel I.', 3),
        (3, 'TERCER SEMESTRE', 'Construcción de acciones interventoras en IAPT II.', 3),
        (3, 'TERCER SEMESTRE', 'Ciencia, Tecnología y Sociedad para los Procesos Transformadores.', 3),
        (3, 'TERCER SEMESTRE', 'Cambio II y su didáctica.', 3),
        (3, 'TERCER SEMESTRE', 'Forma y dimensión II y su didáctica.', 3),
        (3, 'TERCER SEMESTRE', 'Producción ecológica de alimentos y soberanía alimentaria I.', 3),
        (4, 'CUARTO SEMESTRE', 'Intervención fundamentada de la práctica docente. Nivel II.', 3),
        (4, 'CUARTO SEMESTRE', 'Construcción de acciones interventoras en IAPT II.', 3),
        (4, 'CUARTO SEMESTRE', 'El materialismo historico dialectico para los procesos transformadores', 3),
        (4, 'CUARTO SEMESTRE', 'Cambio III y su didáctica.', 3),
        (4, 'CUARTO SEMESTRE', 'Trigonometría y su didáctica.', 3),
        (4, 'CUARTO SEMESTRE', 'Producción ecológica de alimentos y soberanía alimentaria II.', 3),
        (5, 'QUINTO SEMESTRE', 'Valoración de la Intervención de la práctica docente. Nivel I.', 3),
        (5, 'QUINTO SEMESTRE', 'Ejecución de acciones interventoras en IAPT III', 3),
        (5, 'QUINTO SEMESTRE', 'Consolidación de la Pedagogía Crítica desde la conciencia de Clase.', 3),
        (5, 'QUINTO SEMESTRE', 'Cambio IV y su didáctica.', 3),
        (5, 'QUINTO SEMESTRE', 'Incertidumbre I y su didáctica', 3),
        (5, 'QUINTO SEMESTRE', 'Producción de bienes de consumo masivo I.', 3),
        (6, 'SEXTO SEMESTRE', 'Consolidación de la práctica docente crítica. Nivel I.', 3),
        (6, 'SEXTO SEMESTRE', 'Valoración de acciones interventoras en IAPT II', 3),
        (6, 'SEXTO SEMESTRE', 'Desarrollo de procesos transformadores fundamentados en la formación en la conciencia pedagógica crítica.', 3),
        (6, 'SEXTO SEMESTRE', 'Geometría y su didáctica, entre la teoría axiomática y el contexto.', 3),
        (6, 'SEXTO SEMESTRE', 'Incertidumbre II y su didáctica', 3),
        (6, 'SEXTO SEMESTRE', 'Producción de bienes de consumo masivo II.', 3),
        (7, 'SEPTIMO SEMESTRE', 'Valoración de la Intervención de la práctica docente. Nivel II', 3),
        (7, 'SEPTIMO SEMESTRE', 'Ejecución de acciones interventoras en IAPT IV', 3),
        (7, 'SEPTIMO SEMESTRE', 'Pedagogía Crítica como eje articulador en la concreción del Plan de Patria.', 3),
        (7, 'SEPTIMO SEMESTRE', 'CIRCUITO LÒGICO FUNCIONES BOOLE YAPLICACION (ELECTIVA)', 3),
        (7, 'SEPTIMO SEMESTRE', 'CONJETURA,PROBAR COMPROBAR EN MATEMATICA (ELECTIVA)', 3),
        (7, 'SEPTIMO SEMESTRE', 'Innovación y emprendimientos I.', 3),
        (8, 'OCTAVO SEMESTRE', 'Consolidación de la práctica docente crítica. Nivel II.', 3),
        (8, 'OCTAVO SEMESTRE', 'Valoración de acciones interventoras en IAPT III', 3),
        (8, 'OCTAVO SEMESTRE', 'El Socialismo Bolivariano y la Educación', 3),
        (8, 'OCTAVO SEMESTRE', 'EVALUACION DE LOS APRENDIZAJES EN MATEMATICA (ELECTIVA)', 3),
        (8, 'OCTAVO SEMESTRE', 'LUDICA ANCESTRAL MATEMATICA (ELECTIVA)', 3),
        (8, 'OCTAVO SEMESTRE', 'Innovación y emprendimientos II.', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN FÍSICA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Proyecto Práctica Docente Transformadora I.', 3),
        (1, 'PRIMER TRIMESTRE', 'Teoría Social del Aprendizaje: Pedagogía y Didáctica Critica en Ciencia', 3),
        (1, 'PRIMER TRIMESTRE', 'Elementos Teórico Prácticos de la Fisica I.A', 3),
        (1, 'PRIMER TRIMESTRE', 'Matematica I', 3),
        (1, 'PRIMER TRIMESTRE', 'Laboratorio: Vinculación Teórico Prácticos I.A Integración de las Ciencias Naturales', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Proyecto Práctica Docente Transformadora II', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Planificación Educativa por Proyecto', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Elementos Teórico Prácticos de la Fisica I.B', 3),
        (2, 'SEGUNDO TRIMESTRE', 'MatematicaII', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Laboratorio: Vinculación Teórico Prácticos I.B Integración de las Ciencias Naturales', 3),
        (3, 'TERCER TRIMESTRE', 'Proyecto Práctica Docente Transformadora III', 3),
        (3, 'TERCER TRIMESTRE', 'Evaluación y Valoración de los Aprendizajes', 3),
        (3, 'TERCER TRIMESTRE', 'Elementos Teórico Prácticos de la Fisica I.C', 3),
        (3, 'TERCER TRIMESTRE', 'Matematica III', 3),
        (3, 'TERCER TRIMESTRE', 'Laboratorio: Vinculación Teórico Prácticos I.C Integración de las Ciencias Naturales', 3),
        (4, 'CUARTO TRIMESTRE', 'Proyecto Práctica Docente Transformadora IV', 3),
        (4, 'CUARTO TRIMESTRE', 'Uso Crítico De las TIC', 3),
        (4, 'CUARTO TRIMESTRE', 'Elementos Teórico Prácticos de la Fisica II.A', 3),
        (4, 'CUARTO TRIMESTRE', 'Fisica y Entorno Social', 3),
        (4, 'CUARTO TRIMESTRE', 'Laboratorio: Vinculación Teórico Prácticos II.A Integración de las Ciencias Naturales', 3),
        (5, 'QUINTO TRIMESTRE', 'Proyecto Práctica Docente Transformadora V', 3),
        (5, 'QUINTO TRIMESTRE', 'Necesidades Educativas e Integración de Estudiantes con Discapacidad', 3),
        (5, 'QUINTO TRIMESTRE', 'Elementos Teórico Prácticos de la Fisica II.B', 3),
        (5, 'QUINTO TRIMESTRE', 'Cultura y Ecologia Social', 3),
        (5, 'QUINTO TRIMESTRE', 'Laboratorio: Vinculación Teórico Prácticos II.B Integración de las Ciencias Naturales', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto Práctica Docente Transformadora VI', 3),
        (6, 'SEXTO TRIMESTRE', 'Educación para la Paz y para la Vida', 3),
        (6, 'SEXTO TRIMESTRE', 'Elementos Teórico Prácticos de la Fisica II. C', 3),
        (6, 'SEXTO TRIMESTRE', 'Laboratorio: Vinculación Teórico Prácticos II.C Integración de las Ciencias Naturales', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Proyecto P`ractica Docente Transformadora VII', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Seminario: Pensamiento Pedagógico Liberador Nuestroamericano', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Ciencias Naturales para la Transformación Social I', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Laboratorio Procesos Didácticos de la Física I', 3),
        (8, 'OCTAVO TRIMESTRE', 'Proyecto Práctica Docente Transformadora VIII', 3),
        (8, 'OCTAVO TRIMESTRE', 'Desarrollo de la Ciudadania Critica', 3),
        (8, 'OCTAVO TRIMESTRE', 'Ciencias Naturales para la Transformación Social II', 3),
        (8, 'OCTAVO TRIMESTRE', 'Laboratorio Procesos Didácticos de la Física II', 3),
        (9, 'NOVENO TRIMESTRE', 'Proyecto Práctica Docente Transformadora IX', 3),
        (9, 'NOVENO TRIMESTRE', 'Procesos Históricos Políticos de la Educación Venezolana Nuestroamericana en el Siglo XXI', 3),
        (9, 'NOVENO TRIMESTRE', 'Ciencias Naturales para la Transformacion Social III', 3),
        (9, 'NOVENO TRIMESTRE', 'Laboratorio Procesos Didácticos de la Física III', 3),
        (10, 'DECIMO TRIMESTRE', 'Proyecto Práctica Docente Transformadora X', 3),
        (10, 'DECIMO TRIMESTRE', 'Taller: Metodología IAPT', 3),
        (10, 'DECIMO TRIMESTRE', 'Taller: Procesos Didácticos Interdisciplinarios en Fisica', 3),
        (10, 'DECIMO TRIMESTRE', 'Laboratorio: Procesos de Investigación, Creación e Innovación en las Ciencias Naturales I', 3),
        (10, 'DECIMO  PRIMER TRIMESTRE', 'Proyecto Práctica Docente Transformadora XI', 3),
        (10, 'DECIMO  PRIMER TRIMESTRE', 'Taller: Sistematización IAPT', 3),
        (10, 'DECIMO  PRIMER TRIMESTRE', 'Laboratorio: Procesos de Investigación, Creación e Innovacián en las Ciencias Naturales II', 3),
        (10, 'DECIMO  SEGUNDO TRIMESTRE', 'Proyecto P`ractica Docente Transformadora XII', 3),
        (10, 'DECIMO  SEGUNDO TRIMESTRE', 'Taller: Planificación IAPT', 3),
        (10, 'DECIMO  SEGUNDO TRIMESTRE', 'Seminario: Procesos Socioproductivos: Física de Nuestros Dias', 3),
        (10, 'DECIMO  SEGUNDO TRIMESTRE', 'Curso: Principios Físicos aplicados a la Producción', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN QUÍMICA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IA', 3),
        (1, 'PRIMER TRIMESTRE', 'Teoría Social del Aprendizaje', 3),
        (1, 'PRIMER TRIMESTRE', 'Pedagogía y Didáctica Crítica', 3),
        (1, 'PRIMER TRIMESTRE', 'Matemática I', 3),
        (1, 'PRIMER TRIMESTRE', 'Laboratorio Vinculación Teórico Práctica IA: Integración de las Ciencias Naturales', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IB', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Planificación Educativa por Proyectos', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Matemática II', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Laboratorio Vinculación Teórico Práctica IB: Integración de las Ciencias Naturales', 3),
        (3, 'TERCER TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IC', 3),
        (3, 'TERCER TRIMESTRE', 'Evaluación y Valoración de los Aprendizajes', 3),
        (3, 'TERCER TRIMESTRE', 'Matemática III', 3),
        (3, 'TERCER TRIMESTRE', 'Laboratorio Vinculación Teórico Práctica IC: Integración de las Ciencias Naturales', 3),
        (4, 'CUARTO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IIA', 3),
        (4, 'CUARTO TRIMESTRE', 'Uso crítico de las Tecnologías y la Comunicación', 3),
        (4, 'CUARTO TRIMESTRE', 'Elementos Teóricos Prácticos de la Química y su aplicación IIA', 3),
        (4, 'CUARTO TRIMESTRE', 'Química y Entorno Social I', 3),
        (4, 'CUARTO TRIMESTRE', 'Laboratorio Vinculación Teórico Práctica IIA: Integración de las Ciencias Naturales', 3),
        (5, 'QUINTO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IIB', 3),
        (5, 'QUINTO TRIMESTRE', 'Necesidades Educativas Especiales e Integración', 3),
        (5, 'QUINTO TRIMESTRE', 'Elementos Teóricos Prácticos de la Química y su aplicación IIB', 3),
        (5, 'QUINTO TRIMESTRE', 'Química y Entorno Social II', 3),
        (5, 'QUINTO TRIMESTRE', 'Laboratorio Vinculación Teórico Práctica IIB: Integración de las Ciencias Naturales', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IIC', 3),
        (6, 'SEXTO TRIMESTRE', 'Educación para la Paz y la Vida', 3),
        (6, 'SEXTO TRIMESTRE', 'Elementos Teóricos Prácticos de la Química y su aplicación IIC', 3),
        (6, 'SEXTO TRIMESTRE', 'Química y Entorno Social III', 3),
        (6, 'SEXTO TRIMESTRE', 'Laboratorio Vinculación Teórico Práctica IIC: Integración de las Ciencias Naturales', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IIIA', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Pensamiento Pedagógico Liberador', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Ciencias Naturales para la Transformación Social I', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Laboratorio Procesos Didácticos de la Química I', 3),
        (8, 'OCTAVO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IIIB', 3),
        (8, 'OCTAVO TRIMESTRE', 'Desarrollo de la Ciudadanía Crítica', 3),
        (8, 'OCTAVO TRIMESTRE', 'Ciencias Naturales para la Transformación Social II', 3),
        (8, 'OCTAVO TRIMESTRE', 'Laboratorio Procesos Didácticos de la Química II', 3),
        (9, 'NOVENO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IIIC', 3),
        (9, 'NOVENO TRIMESTRE', 'Procesos Histórico Políticos de la Educación Nuestro americana del Siglo XX', 3),
        (9, 'NOVENO TRIMESTRE', 'Ciencias Naturales para la Transformación Social III', 3),
        (9, 'NOVENO TRIMESTRE', 'Laboratorio Procesos Didácticos de la Química III', 3),
        (10, 'DECIMO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IVA', 3),
        (10, 'DECIMO TRIMESTRE', 'Taller Metodología Investigación y Acción Participativa', 3),
        (10, 'DECIMO TRIMESTRE', 'Laboratorio Procesos de Investigación, Creación e Innovación en las Ciencias Naturales', 3),
        (10, 'DECIMO TRIMESTRE', 'Procesos Didácticos Interdisciplinarios en Química', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IVB', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Ciencias Naturales para la Transformación Social IV', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Planificación y Evaluación de la PD- IAPT', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Proyecto: Práctica Docente Transformadora IVC', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Taller Planificación y Evaluación de la PD-IAPT', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Historia y Principios Químicos aplicados a los procesos productivos|', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Seminario Procesos Socio productivos: Las bases de la vida', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN BIOLOGÍA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Proyecto Práctica Docente Transformadora I.A', 3),
        (1, 'PRIMER TRIMESTRE', 'Teoría Social del aprendizaje', 3),
        (1, 'PRIMER TRIMESTRE', 'Pedagogía y Didactica Critica en el area de Ciencias Naturales', 3),
        (1, 'PRIMER TRIMESTRE', 'Elementos Teórico Prácticos de la Biologia I.A', 3),
        (1, 'PRIMER TRIMESTRE', 'Biomatematica', 3),
        (1, 'PRIMER TRIMESTRE', 'Laboratorio: Integración de las Ciencias Naturales I.A', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Proyecto Práctica Docente Transformadora I.B', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Planificación Educativa por Proyectos', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Elementos Teórico Prácticos de la Biologia I B', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Quimica', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Laboratorio: Integración de las Ciencias Naturales I.B', 3),
        (3, 'TERCER TRIMESTRE', 'Proyecto Práctica Docente Transformadora I.C', 3),
        (3, 'TERCER TRIMESTRE', 'Evaluación y valoración de los aprendizajes', 3),
        (3, 'TERCER TRIMESTRE', 'Elementos Teórico Prácticos de la Biologia I C', 3),
        (3, 'TERCER TRIMESTRE', 'Fisica', 3),
        (3, 'TERCER TRIMESTRE', 'Laboratorio: Integración de las Ciencias Naturales I.C', 3),
        (4, 'CUARTO TRIMESTRE', 'Proyecto Práctica Docente Transformadora II.A', 3),
        (4, 'CUARTO TRIMESTRE', 'Uso Crítico de las TIC en el Ámbito Educativo', 3),
        (4, 'CUARTO TRIMESTRE', 'Elementos Teórico Prácticos de la Biologia II.A', 3),
        (4, 'CUARTO TRIMESTRE', 'Biologia Social y Biodiversidad', 3),
        (4, 'CUARTO TRIMESTRE', 'Laboratorio Teorico-Practico II.A', 3),
        (5, 'QUINTO TRIMESTRE', 'Proyecto Práctica Docente Transformadora II.B', 3),
        (5, 'QUINTO TRIMESTRE', 'Necesidades Educativas e Integración', 3),
        (5, 'QUINTO TRIMESTRE', 'Elementos Teórico Prácticos de la Biologia II B', 3),
        (5, 'QUINTO TRIMESTRE', 'Cultura Ecologica Social', 3),
        (5, 'QUINTO TRIMESTRE', 'Laboratorio Teorico-Práctico II.B', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto Práctica Docente Transformadora II.C', 3),
        (6, 'SEXTO TRIMESTRE', 'Educación para la Paz y la Vida', 3),
        (6, 'SEXTO TRIMESTRE', 'Elementos Teórico Prácticos de la Biología IIC y sus Aplicaciones', 3),
        (6, 'SEXTO TRIMESTRE', 'Laboratorio Teorico-Practico II.C', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Proyecto Práctica Docente Transformadora III.A', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Seminario: Pensamiento Pedagógico Liberador Nuestroamericano', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Ciencias Naturales para la transformacion Social I', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Laboratorio Integracion de los procesos Didacticos de la Biologia IA', 3),
        (8, 'OCTAVO TRIMESTRE', 'Proyecto Práctica Docente Transformadora III.B', 3),
        (8, 'OCTAVO TRIMESTRE', 'Desarrollo de la Ciudadania Critica', 3),
        (8, 'OCTAVO TRIMESTRE', 'Ciencias Naturales para la transformacion Social II', 3),
        (8, 'OCTAVO TRIMESTRE', 'Laboratorio Integración de los procesos Didácticos de la Biologia I.B', 3),
        (9, 'NOVENO TRIMESTRE', 'Proyecto Práctica Docente Transformadora III.C', 3),
        (9, 'NOVENO TRIMESTRE', 'Procesos Histórico Políticos de la Educación Nuestroamericana', 3),
        (9, 'NOVENO TRIMESTRE', 'Ciencias Naturales para la transformacion Social III', 3),
        (9, 'NOVENO TRIMESTRE', 'Laboratorio Integración de los procesos Didácticos de la Biologia I.C', 3),
        (10, 'DECIMO TRIMESTRE', 'Proyecto Práctica Docente Transformadora IV.A', 3),
        (10, 'DECIMO TRIMESTRE', 'Taller: Metodología IAPT', 3),
        (10, 'DECIMO TRIMESTRE', 'Taller: Procesos Interdisciplinarios en Biologia', 3),
        (10, 'DECIMO TRIMESTRE', 'Laboratorio: Procesos de Investigación. Creacion e innovación de las Ciencias Naturales I', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Proyecto Práctica Docente Transformadora IV.B', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Taller: Sistematización IAPT', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Ciencias Naturales para la Transformación Social IV', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Laboratorio: Procesos de Investigación. Creacion e innovación de las Ciencias Naturales II', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Proyecto Práctica Docente Transformadora IV.C', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Taller: Planificación y Evaluacion IAPT', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Laboratorio: Fundamentos de Biologìa Molecular y Celular en actividades Socioproductivas', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Laboratorio: Procesos de Investigación. Creación e innovación de las Ciencias Naturales III', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN MEMORIA, TERRITORIO Y CIUDADANÍA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Praxis Pedagogica Social Robinsoniana', 3),
        (1, 'PRIMER TRIMESTRE', 'Educación Popular', 3),
        (1, 'PRIMER TRIMESTRE', 'El Espacio Geográfico construido', 3),
        (1, 'PRIMER TRIMESTRE', 'Interculturalidad. Raíces Indígenas, Criollas y Afrodescendientes', 3),
        (2, 'SEGUNDO TRIMESTRE', 'La realidad Socio Educativa Venezolana', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Sistema Educativo Venezolano', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Sentido de Territorialidad:', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Realidad socio productiva de la Comunidad y Comuna', 3),
        (3, 'TERCER TRIMESTRE', 'Saberes del Pueblo y Estado Docente', 3),
        (3, 'TERCER TRIMESTRE', 'Protagonista de la vida escolar', 3),
        (3, 'TERCER TRIMESTRE', 'Organización del Espacio en la Venezuela Agraria', 3),
        (3, 'TERCER TRIMESTRE', 'Experiencias de organización en Venezuela', 3),
        (4, 'CUARTO TRIMESTRE', 'Cotidianidad Escolar', 3),
        (4, 'CUARTO TRIMESTRE', 'Evaluación y Valoración de Aprendizaje', 3),
        (4, 'CUARTO TRIMESTRE', 'Soporte Natural de la Diversidad Territorial Venezolana', 3),
        (4, 'CUARTO TRIMESTRE', 'Estudios lugarizados del Territorio', 3),
        (5, 'QUINTO TRIMESTRE', 'Familia, Escuela, Comunidad y Diversidad Geohistoríca', 3),
        (5, 'QUINTO TRIMESTRE', 'Enseñanza y Aprendizaje', 3),
        (5, 'QUINTO TRIMESTRE', 'Fronterización del territorio', 3),
        (5, 'QUINTO TRIMESTRE', 'Diáspora y neo diáspora en el Espacio Comunal', 3),
        (6, 'SEXTO TRIMESTRE', 'Pedagogia y Praxis Contextualizada', 3),
        (6, 'SEXTO TRIMESTRE', 'Escuela, Estado Docente y Poderes fácticos', 3),
        (6, 'SEXTO TRIMESTRE', 'Historia Regional y Local', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Praxis Docente sustentada en el dialogo de saberes', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Análisis crítico liberador del contexto social', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Movimientos Emancipadores de Nuestramerica', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Integración Latinoamericana y Caribeña', 3),
        (8, 'OCTAVO TRIMESTRE', 'Potencialidades Docentes para IAPT', 3),
        (8, 'OCTAVO TRIMESTRE', 'Capitalismo y Socialismo: implicaciones políticas, socioeconómicas y culturales', 3),
        (8, 'OCTAVO TRIMESTRE', 'Pensamiento Bolivariano', 3),
        (8, 'OCTAVO TRIMESTRE', 'Ideario Bolivariano VS Doctrina Monroe', 3),
        (9, 'NOVENO TRIMESTRE', 'Estado Docente Postulados Ideologicos', 3),
        (9, 'NOVENO TRIMESTRE', 'Amenaza Capitalista para el desarrollo de los pueblos', 3),
        (9, 'NOVENO TRIMESTRE', 'Republicanismo y Ciudadania', 3),
        (9, 'NOVENO TRIMESTRE', 'Descolonización del pensamiento latinoamericano y caribeño', 3),
        (10, 'DECIMO TRIMESTRE', 'Educación y Comunicación', 3),
        (10, 'DECIMO TRIMESTRE', 'Democratización de la Propiedad de la Tierra y Seguridad Alimentaria', 3),
        (10, 'DECIMO TRIMESTRE', 'La Naturaleza como mercancía en el modo de producción', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Independencia Nacional, Socialismo, Pedagogía y descolonizacion en el contexto local-regional latinoamericano', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Venezuela y su Geopolítica Internacional', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Petróleo y Soberanía', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Socialismo Bolivariano y Pedagogia Critica', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Dependencia y Cultura de la renta', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Autogestión e Independencia', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN EDUCACIÓN FÍSICA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Proyecto I: Bases Teóricas y Legales del Curriculum del Area de Educacion Fisica en Venezuela', 3),
        (1, 'PRIMER TRIMESTRE', 'El docente venezolano', 3),
        (1, 'PRIMER TRIMESTRE', 'Educación Física: Conceptualización y Enfoques', 3),
        (1, 'PRIMER TRIMESTRE', 'El Lenguaje del Cuerpo', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Proyecto II: Teoría y Practica de la planificacion Docente', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Educación Fisica y sus Manifestaciones en el Imaginario Social Comunitario', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Pedagogía de la Educación Física', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Educación Física y Convivencia I', 3),
        (3, 'TERCER TRIMESTRE', 'Proyecto III: Evaluación de los Procesos formativos en Educación Física', 3),
        (3, 'TERCER TRIMESTRE', 'Educación Fisica como medio de Transformación Social', 3),
        (3, 'TERCER TRIMESTRE', 'Educación Física y Convivencia II', 3),
        (4, 'CUARTO TRIMESTRE', 'Proyecto IV: Conocimiento de la Escuela', 3),
        (4, 'CUARTO TRIMESTRE', 'Educación Física y modelos de desarrollo', 3),
        (4, 'CUARTO TRIMESTRE', 'Educación Física y Motricidad Humana', 3),
        (4, 'CUARTO TRIMESTRE', 'Cultura, Ritmo y movimiento', 3),
        (5, 'QUINTO TRIMESTRE', 'Proyecto V: La Investigacion, fundamento de la practica docente', 3),
        (5, 'QUINTO TRIMESTRE', 'Psicologia y pensamiento Socio Critico', 3),
        (5, 'QUINTO TRIMESTRE', 'Desarrollo Motor', 3),
        (5, 'QUINTO TRIMESTRE', 'Educación Física y Procesos Cognitivos', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto VI: La Educación Fisica en el Territorio: Diagnostico y Potencialidades de la Educación Fisica para la Transformación Social', 3),
        (6, 'SEXTO TRIMESTRE', 'Educación Física y participacion colectiva en el territorio', 3),
        (6, 'SEXTO TRIMESTRE', 'Rondas, Canciones y Juegos Infantiles en la Educación Física', 3),
        (6, 'SEXTO TRIMESTRE', 'Ciudadanía, Legislación y Disciplina', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Proyecto VII: Sistematización de los Procesos Pedagógicos del área de Educación Física', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Ciencia, Tecnología y Sociedad para los Procesos Transformadores', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Educación Física Escolar: Medios Educativos para el desarrollo motor', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Pensamiento y Comunicación', 3),
        (8, 'OCTAVO TRIMESTRE', 'Desarrollo de la Investigación Acción Participativa I', 3),
        (8, 'OCTAVO TRIMESTRE', 'Educación Física Escolar: Medios Educativos para la Consolidación de la Motricidad Infantil', 3),
        (8, 'OCTAVO TRIMESTRE', 'Educación Física y Diversidad', 3),
        (9, 'NOVENO TRIMESTRE', 'Desarrollo de la Investigación Acción Participativa II', 3),
        (9, 'NOVENO TRIMESTRE', 'Educación Física para la Descolonización', 3),
        (9, 'NOVENO TRIMESTRE', 'Atención a la Diversidad desde la Educacion Fisica', 3),
        (10, 'DECIMO TRIMESTRE', 'Desarrollo de la Investigación Acción Participativa III', 3),
        (10, 'DECIMO TRIMESTRE', 'Cuerpo y Pedagogía para la Transformación Pedagógica en el Territorio', 3),
        (10, 'DECIMO TRIMESTRE', 'Educación Física y los Medios para su desarrollo I', 3),
        (10, 'DECIMO TRIMESTRE', 'Educación Física y Ambiente', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Desarrollo de la Investigación Acción Participativa IV', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Pensamiento Pedagógico, Bolivariano y Latinoamericano', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Educación Física y los Medios para su desarrollo II', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Prevención y Atención de Emergencia en Ambientes Escolares', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Desarrollo de la Investigación Acción Participativa V', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Venezuela Potencia: Aportes desde la Educación Física', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Educación Física y los Medios para su desarrollo Iii', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN INGLÉS': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Observación en la Escuela', 3),
        (1, 'PRIMER TRIMESTRE', 'Pensamiento Critico', 3),
        (1, 'PRIMER TRIMESTRE', 'Introducción al Inglés', 3),
        (1, 'PRIMER TRIMESTRE', 'Produccion Escrita', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Conociendo a la Comuna', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Pedagogia Critica', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Inglés en la Escuela Primaria', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Alfabetización Tecnologica', 3),
        (3, 'TERCER TRIMESTRE', 'Diagnóstico y Sistematización', 3),
        (3, 'TERCER TRIMESTRE', 'Didactica Critica', 3),
        (3, 'TERCER TRIMESTRE', 'Inglés en el Contexto Social', 3),
        (3, 'TERCER TRIMESTRE', 'Desarrollo Tecnologico Educativo', 3),
        (4, 'CUARTO TRIMESTRE', 'Metodología de la Investigación', 3),
        (4, 'CUARTO TRIMESTRE', 'Planes y Proyectos del Sistema Educativo Venezolano', 3),
        (4, 'CUARTO TRIMESTRE', 'Inglés en el Contexto Global', 3),
        (4, 'CUARTO TRIMESTRE', 'identidad comunal', 3),
        (5, 'QUINTO TRIMESTRE', 'investigación Educativa', 3),
        (5, 'QUINTO TRIMESTRE', 'Planificación Educativa', 3),
        (5, 'QUINTO TRIMESTRE', 'Introducción a la Gramática de Inglés', 3),
        (5, 'QUINTO TRIMESTRE', 'Diversidad e Inclusion', 3),
        (6, 'SEXTO TRIMESTRE', 'Ética de la Investigación Docente', 3),
        (6, 'SEXTO TRIMESTRE', 'Filosofía y Pedagogía para la Transformación', 3),
        (6, 'SEXTO TRIMESTRE', 'Producción Oral en Inglés', 3),
        (6, 'SEXTO TRIMESTRE', 'Valores, familia y sociedad', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Docente y Contexto Educativo', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Ciudadanía y Legislación', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Inglés', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Salud Integral', 3),
        (8, 'OCTAVO TRIMESTRE', 'IAP y la Enseñanza del Ingles I', 3),
        (8, 'OCTAVO TRIMESTRE', 'Psicología Educativa', 3),
        (8, 'OCTAVO TRIMESTRE', 'Sintaxis', 3),
        (8, 'OCTAVO TRIMESTRE', 'Ambiente', 3),
        (9, 'NOVENO TRIMESTRE', 'IAP y la Enseñanza del Ingles II', 3),
        (9, 'NOVENO TRIMESTRE', 'Planificación de la Enseñanza del Inglés como Lengua Extranjera I', 3),
        (9, 'NOVENO TRIMESTRE', 'Fonetica y Fonologia', 3),
        (9, 'NOVENO TRIMESTRE', 'Culturas originarias e Identidad', 3),
        (10, 'DECIMO TRIMESTRE', 'Praxis Docente en IAPT I', 3),
        (10, 'DECIMO TRIMESTRE', 'Evaluación de la enseñanza del Ingles', 3),
        (10, 'DECIMO TRIMESTRE', 'Escritura Académica', 3),
        (10, 'DECIMO TRIMESTRE', 'Desarrollo Endogeno del Siglo XXI', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Praxis Docente en IAPT II', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Contexto Social Nuestroameriano', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Inglés Técnico', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Cultura Anglófona', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Praxis Docente en IAPT III', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Lenguaje y Comunicación', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Literatura Anglófona', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Ciencia, Tecnología y Comunicación para los Procesos de Transformación', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN EDUCACIÓN INICIAL': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA I', 3),
        (1, 'PRIMER SEMESTRE', 'EDUCACIÓN BOLIVARIANA Y SOCIEDAD', 3),
        (1, 'PRIMER SEMESTRE', 'USO SOCIAL DE LA LENGUA', 3),
        (1, 'PRIMER SEMESTRE', 'DESARROLLO Y CRECIMIENTO DEL NIÑO Y LA NIÑA EN EL CONTEXTO VENEZOLANO', 3),
        (1, 'PRIMER SEMESTRE', 'FORMACIÓN SOCIO CRITICA I', 3),
        (1, 'PRIMER SEMESTRE', 'GESTIÓN DE RIEGOS Y PROTECCION CIVIL', 3),
        (2, 'SEGUNDO SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA II', 3),
        (2, 'SEGUNDO SEMESTRE', 'PEDAGOGIA TRANSFORMADORA', 3),
        (2, 'SEGUNDO SEMESTRE', 'CIMIENTOS DE LA EDUCACION INICIAL', 3),
        (2, 'SEGUNDO SEMESTRE', 'LAS TICs EN LA EDUC BOLIVARIANA', 3),
        (2, 'SEGUNDO SEMESTRE', 'LA ACTIVIDAD FISICA , EL JUEGO Y LA RECREACION EL EDUC INICIAL', 3),
        (2, 'SEGUNDO SEMESTRE', 'FORMACIÓN SOCIO CRITICA II', 3),
        (2, 'SEGUNDO SEMESTRE', 'LENGUAS INDIGENAS (ELECTIVA)', 3),
        (3, 'TERCER SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA III', 3),
        (3, 'TERCER SEMESTRE', 'MATEMATICA Y ESTADISTICA APLICADA A LO SOCIO EDUCATIVO', 3),
        (3, 'TERCER SEMESTRE', 'EDUCACION Y TERRITORIALIDAD', 3),
        (3, 'TERCER SEMESTRE', 'CURRICULO EN EL SISTEMA EDUCATIVO VENEZOLANO', 3),
        (3, 'TERCER SEMESTRE', 'TRADICIONES Y COSTUMBRES DEL PUEBLO VENEZOLANO', 3),
        (3, 'TERCER SEMESTRE', 'FORMACIÓN SOCIO CRITICA III', 3),
        (3, 'TERCER SEMESTRE', 'AMBIENTE Y SALUD INTEGRAL', 3),
        (4, 'CUARTO SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA IV', 3),
        (4, 'CUARTO SEMESTRE', 'DESARROLLO SOCIO AFECTIVO Y LA INTELIGENCIA', 3),
        (4, 'CUARTO SEMESTRE', 'RESPONSABILIDAD SOCIAL FAMILIA ESCUELA Y COMUNIDAD', 3),
        (4, 'CUARTO SEMESTRE', 'EDUCACION SEXUAL Y REPREODUCTIVA', 3),
        (4, 'CUARTO SEMESTRE', 'DESEMPEÑO PROFESIONAL DEL DOCENTE DE EDU INICIAL', 3),
        (4, 'CUARTO SEMESTRE', 'FORMACIÓN SOCIO CRITICA IV', 3),
        (4, 'CUARTO SEMESTRE', 'ALIMENTACIÒN SANA Y ALTERNATIVA EN EDUC INICIAL ELECTIVA', 3),
        (5, 'QUINTO  SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA V', 3),
        (5, 'QUINTO  SEMESTRE', 'PLANIFICACIÓN Y EVALUACION EN EDUCACIÓN INICIAL', 3),
        (5, 'QUINTO  SEMESTRE', 'DERECHOS HUMANOS DEL NIÑO Y LA NIÑA EN EL CONTEXTO EDUCATIVO VENEZOLANO', 3),
        (5, 'QUINTO  SEMESTRE', 'PREVENCION Y ATENCION A LA SALUD INTEGRAL DEL NIÑO Y LA NIÑA', 3),
        (5, 'QUINTO  SEMESTRE', 'EXPRESION MUSICAL Y COORPORAL', 3),
        (5, 'QUINTO  SEMESTRE', 'FORMACIÓN SOCIO CRITICA V', 3),
        (5, 'QUINTO  SEMESTRE', 'SABERES ANCESTRALES DE LOS PUEBLOS INDIGENAS', 3),
        (6, 'SEXTO SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA VI', 3),
        (6, 'SEXTO SEMESTRE', 'EDUCACION MATERNAL, LA GESTACION Y EL PARTO HUMANIZADO', 3),
        (6, 'SEXTO SEMESTRE', 'DESARROLLO DE LA LENGUA ORAL Y LENGUA ESCRITA EN ÑINOS DE EDUC INICIAL', 3),
        (6, 'SEXTO SEMESTRE', 'NECESIDADES EDUCATIVAS ESPECIALES Y ATENCION A LA DIVERSIDAD', 3),
        (6, 'SEXTO SEMESTRE', 'EXPRESION TEATRAL Y DANZAS TRADICIONALES DE VENEZUELA', 3),
        (6, 'SEXTO SEMESTRE', 'FORMACIÓN SOCIO CRITICA VI', 3),
        (6, 'SEXTO SEMESTRE', 'CREATIVIDAD E INNOVACIÒN EN EDU INICIAL ELECTIVA', 3),
        (7, 'SEPTIMO SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA VII', 3),
        (7, 'SEPTIMO SEMESTRE', 'DESARROLLO DE LOS PROCESOS LOGICO MATEMATICOS EN EL NIÑO DE EDUCACION', 3),
        (7, 'SEPTIMO SEMESTRE', 'EXPRESION PLASTICA DEL NIÑO EN EDU INICIAL', 3),
        (7, 'SEPTIMO SEMESTRE', 'PROMOCION DE LA LECTURA PARA NIÑOS Y NIÑAS DE EDUCACION INICIAL', 3),
        (7, 'SEPTIMO SEMESTRE', 'FORMACIÓN SOCIO CRITICA VII', 3),
        (7, 'SEPTIMO SEMESTRE', 'TRANSFORMACIÓN DE MATERIALES Y RECURSOS PARA LA EDUCACIÓN INICIAL', 3),
        (8, 'OCTAVO SEMESTRE', 'PROYECTO SOCIO INTEGRADOR: PRACTICA PROFESIONAL TRANSFORMADORA VIII', 3),
        (8, 'OCTAVO SEMESTRE', 'PROCESOS ADMINISTRATIVOS EN LA EDUC INICIAL EN VENEZUELA', 3),
        (8, 'OCTAVO SEMESTRE', 'MEDIOS DE COMUNICACIÓN EN DUCACION INICIAL', 3),
        (8, 'OCTAVO SEMESTRE', 'FORMACIÓN SOCIO CRITICA VIII', 3),
        (8, 'OCTAVO SEMESTRE', 'CONTINUIDAD AFECTIVA Y ARTICULACIÓN PEDAGOGICA EN EDUC INICIAL ELECTIVA', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN LENGUA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Ideas pedagogicas venezolanas precursoras en la transformacion educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'La lengua como sistema: lo gramatical, ortografico y semantico', 3),
        (1, 'PRIMER TRIMESTRE', 'Lenguajes digitales y la Educacion', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Educacion Bolivariana: constructo historico politico', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Discurso texto y contexto', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Poderes creadores del pueblo y educacion', 3),
        (3, 'TERCER TRIMESTRE', 'Sistema Educativo y su comunalizacion', 3),
        (3, 'TERCER TRIMESTRE', 'Lectura sujeto y mundo', 3),
        (3, 'TERCER TRIMESTRE', 'Lengua de la Diversidad Intercultural Venezolana', 3),
        (4, 'CUARTO TRIMESTRE', 'Proyecto: Integración Socioeducativa y Lenguaje I', 3),
        (4, 'CUARTO TRIMESTRE', 'Didáctica Crítica y Curriculo', 3),
        (4, 'CUARTO TRIMESTRE', 'Producir y comprender textos', 3),
        (4, 'CUARTO TRIMESTRE', 'Alternativas institucionales para la promocion de las practicas sociales de la Lengua', 3),
        (5, 'QUINTO TRIMESTRE', 'Proyecto: Integración Socioeducativa y Lenguaje II', 3),
        (5, 'QUINTO TRIMESTRE', 'Psicologia y Educacion', 3),
        (5, 'QUINTO TRIMESTRE', 'Planeacion didactica de la lectura y la escritura', 3),
        (5, 'QUINTO TRIMESTRE', 'Lenguaje oral y escrito en otros formatos:LSV y Sistema Braille', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto: Integración Socioeducativa y Lenguaje III', 3),
        (6, 'SEXTO TRIMESTRE', 'Educación con Sentido de humanidad estetica y docencia', 3),
        (6, 'SEXTO TRIMESTRE', 'Literatura para todos y todas', 3),
        (6, 'SEXTO TRIMESTRE', 'El lenguaje de las Artes', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Proyecto: Aplicación del Proyecto I', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Pensamiento Pedagogico Liberador Nuestroamericano I', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Oralidad literatura y comunidad', 3),
        (7, 'SEPTIMO TRIMESTRE', 'El lenguaje de la imagen', 3),
        (8, 'OCTAVO TRIMESTRE', 'Proyecto: Aplicación del Proyecto II', 3),
        (8, 'OCTAVO TRIMESTRE', 'Pensamiento Pedagogico Liberador Nuestroamericano II', 3),
        (8, 'OCTAVO TRIMESTRE', 'La palabra en el liceo', 3),
        (8, 'OCTAVO TRIMESTRE', 'Venezuela contada escrita y filmada', 3),
        (9, 'NOVENO TRIMESTRE', 'Proyecto: Aplicación del Proyecto III', 3),
        (9, 'NOVENO TRIMESTRE', 'Lectura y escritura para la liberacion', 3),
        (9, 'NOVENO TRIMESTRE', 'Historia de la enseñanza de la lengua en Venezuela', 3),
        (9, 'NOVENO TRIMESTRE', 'Pueblos y lenguas indigenas', 3),
        (10, 'DECIMO TRIMESTRE', 'Proyecto: Sistematización I', 3),
        (10, 'DECIMO TRIMESTRE', 'Estudio critico sobre los sistemas de Poder y Dominacion', 3),
        (10, 'DECIMO TRIMESTRE', 'Humanidad y literatura.¿ Para jovenes ?', 3),
        (10, 'DECIMO TRIMESTRE', 'Lenguaje y Ciber espacio', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Proyecto: Sistematización II', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Independencia Nacional, derechos educativos y formacion de ciudadania', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Leer, oir, escribir y hablar los medios de comunicación', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Leyendo la ciencia', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Proyecto: Sistematización III', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Derechos de la madre tierra', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Literatura y Arte', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Lenguaje y poder', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN EDUCACIÓN PRIMARIA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'El Docente y su Contexto Educativo. (Autobiografía y caracterización del entorno)', 3),
        (1, 'PRIMER TRIMESTRE', 'Ciencias de la Educación', 3),
        (1, 'PRIMER TRIMESTRE', 'Desarrollo humano integral', 3),
        (1, 'PRIMER TRIMESTRE', 'Uso social de la lengua (hablar, escuchar, leer y escribir) del docente', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Técnicas e instrumentos de recolección de datos e información', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Pensamiento pedagógico liberador nuestroamericano', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Identidad,arraigo,soberania e Indepencia', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Legislación Educativa y las Leyes del Poder Popular', 3),
        (3, 'TERCER TRIMESTRE', 'Proyecto I: Diagnóstico Participativo Comunitario. (Del registro a la sistematización de experiencias)', 3),
        (3, 'TERCER TRIMESTRE', 'Pensamiento Pedagógico de Simón Rodríguez', 3),
        (3, 'TERCER TRIMESTRE', 'Geo- Histórico', 3),
        (3, 'TERCER TRIMESTRE', 'Fundamentos políticos, filosóficos y pedagógicos de la Educación Bolivariana', 3),
        (4, 'CUARTO TRIMESTRE', 'Enfoques y Paradigmas de la Investigación Educativa', 3),
        (4, 'CUARTO TRIMESTRE', 'Pedagogía Crítica', 3),
        (4, 'CUARTO TRIMESTRE', 'Matemática para la comprensión del mundo y la Vida', 3),
        (4, 'CUARTO TRIMESTRE', 'Historia de la Educación Primaria en Venezuela', 3),
        (5, 'QUINTO TRIMESTRE', 'Bases teórico-metodológicas de la Sistematización y los Relatos Pedagógicos', 3),
        (5, 'QUINTO TRIMESTRE', 'Formación del Nuevo Republicano', 3),
        (5, 'QUINTO TRIMESTRE', 'Didáctica crítica e integradora', 3),
        (5, 'QUINTO TRIMESTRE', 'Nueva subjetividad y función social del docente bolivariano', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto II: Registro y Sistematización de experiencias como metódica de reflexión y transformación', 3),
        (6, 'SEXTO TRIMESTRE', 'Nuevas lógicas de organización y valoración de los procesos educativos', 3),
        (6, 'SEXTO TRIMESTRE', 'Planificación y evaluación de los aprendizajes', 3),
        (6, 'SEXTO TRIMESTRE', 'Recursos para el Aprendizaje y la Enseñanza', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Bases teórico- metodológicas de la IAPT aplicadas a la educación', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Docencia y práctica reflexiva, innovadora y creativa', 3),
        (7, 'SEPTIMO TRIMESTRE', 'La Educación Popular como alternativa para el trabajo sociocomunitario en la construcción del aprendizaje', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Integración social e inclusión en la Escuela Primaria', 3),
        (8, 'OCTAVO TRIMESTRE', 'IAPT en la praxis pedagógica', 3),
        (8, 'OCTAVO TRIMESTRE', 'Relaciones de poder', 3),
        (8, 'OCTAVO TRIMESTRE', 'Perspectivas en la enseñanza y aprendizaje de la lectura y la escritura', 3),
        (8, 'OCTAVO TRIMESTRE', 'Educación, trabajo social liberador y espacios productivos en la Escuela Primaria', 3),
        (9, 'NOVENO TRIMESTRE', 'Proyecto III: Socialización de la práctica pedagógica a través de la Investigación, Acción Participativa y Transformadora', 3),
        (9, 'NOVENO TRIMESTRE', 'Cultura de convivencia y paz', 3),
        (9, 'NOVENO TRIMESTRE', 'El arte como modo de vivir, sentir y mirar lo estético', 3),
        (9, 'NOVENO TRIMESTRE', 'Educación Intercultural', 3),
        (10, 'DECIMO TRIMESTRE', 'Ecología de los saberes', 3),
        (10, 'DECIMO TRIMESTRE', 'Educación , Territorialización y Comunalización', 3),
        (10, 'DECIMO TRIMESTRE', 'Lenguaje aplicado en las Ciencias y la Tecnología', 3),
        (10, 'DECIMO TRIMESTRE', 'Retos y desafíos de la educación ambiental: Formación ecosocialista', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Comunalización de los espacios de formación e investigación', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Democratización del saber científico', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Educación Integral de la Sexualidad en la Educación Primaria', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Orientación Escolar y Familiar', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Proyecto IV: Experiencia de Transformación Comunitaria', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Contexto jurídico – político de la comunalización de la educación en Venezuela', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Educación Física, Deporte y Recreación', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'El cuerpo, la emocionalidad, la afectividad y la lúdica en los procesos de enseñanza y aprendizaje', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN ADMINISTRACIÓN Y GESTIÓN ESCOLAR': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Proyecto Práctica Institucional I.A: Reconociendo mi Contexto Laboral', 3),
        (1, 'PRIMER TRIMESTRE', 'Enfoque Socio Critico', 3),
        (1, 'PRIMER TRIMESTRE', 'Proceso social del Trabajo', 3),
        (1, 'PRIMER TRIMESTRE', 'Lengua, Cultura y Comunicación', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Proyecto Práctica Institucional I . B: Reconociendo mi Contexto Laboral', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Filosofía para la Transformación de la realidad social', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Politicas Publicas Educativas en Venezuela', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Formación Ciudadana', 3),
        (3, 'TERCER TRIMESTRE', 'Proyecto Práctica Institucional I.C: Reconociendo mi Contexto Laboral', 3),
        (3, 'TERCER TRIMESTRE', 'La Descolonización del pensamiento. Una visión crítica del servicio público.', 3),
        (3, 'TERCER TRIMESTRE', 'Bases legales de la Administración Publica', 3),
        (3, 'TERCER TRIMESTRE', 'Informatica Tecnología y Sociedad', 3),
        (4, 'CUARTO TRIMESTRE', 'Proyecto Práctica Institucional II:A MI Contexto Laboral y la soberania Productiva', 3),
        (4, 'CUARTO TRIMESTRE', 'La Dirección y el Desarrollo Institucional Bolivariano', 3),
        (4, 'CUARTO TRIMESTRE', 'La Planificación Participativa y Democrática en la Gestión Institucional', 3),
        (4, 'CUARTO TRIMESTRE', 'Soberanía e identidad Nacional', 3),
        (5, 'QUINTO TRIMESTRE', 'Proyecto Práctica Institucional II:B MI Contexto Laboral y la soberania Productiva', 3),
        (5, 'QUINTO TRIMESTRE', 'Educación y Economia Social', 3),
        (5, 'QUINTO TRIMESTRE', 'Fundamentos de Administración en el Contexto Educativo', 3),
        (5, 'QUINTO TRIMESTRE', 'Calidad Educativa y Gestión Institucional', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto Práctica Institucional II:C MI Contexto Laboral y la soberania Productiva', 3),
        (6, 'SEXTO TRIMESTRE', 'Educación en, por y para la Producción', 3),
        (6, 'SEXTO TRIMESTRE', 'Administración Escolar', 3),
        (6, 'SEXTO TRIMESTRE', 'Seminario I: Transformación de la práctica laboral', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Psicologia para la transformación de la realidad social', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Manejo de Riesgos Socioambientales en el Contexto Laboral', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Idiomas', 3),
        (8, 'OCTAVO TRIMESTRE', 'Proyecto Práctica Institucional III.B Mi contexto Laboral y la Integracion Sociocomunitaria', 3),
        (8, 'OCTAVO TRIMESTRE', 'Atención al Ciudadano y Etica del servidor Publico', 3),
        (8, 'OCTAVO TRIMESTRE', 'La Actividad Física, Bienestar Personal y Salud Social', 3),
        (9, 'NOVENO TRIMESTRE', 'Proyecto Práctica Institucional III.C Mi contexto Laboral y la Integración Sociocomunitaria', 3),
        (9, 'NOVENO TRIMESTRE', 'Cultura Institucional', 3),
        (9, 'NOVENO TRIMESTRE', 'Servicios Educativos y la Administración Escolar en los niveles y modalidades', 3),
        (9, 'NOVENO TRIMESTRE', 'Clima Organizacional: Cultura emancipadora para el Vivir Bien.', 3),
        (10, 'DECIMO TRIMESTRE', 'Proyecto Práctica Institucional IV:. A Sistematizando la Practica Laboral Transformadora en la institucion Educativa', 3),
        (10, 'DECIMO TRIMESTRE', 'Educación Popular', 3),
        (10, 'DECIMO TRIMESTRE', 'Evaluación Institucional', 3),
        (10, 'DECIMO TRIMESTRE', 'Cultura y Tradiciones Venezolanas', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Proyecto Práctica Institucional IV. B Sistematizando la Practica Laboral Transformadora en la institucion Educativa', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Trabajo voluntario y Productivo', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Uso de las TIC y la Gestión Escolar', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'La Institución Educativa y la Evaluación del Desempeño', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Proyecto Práctica Institucional IV.C :Sistematizando la Practica Laboral Transformadora en la institucion Educativa', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Comunalización y construcción del Poder Popular', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Gestión Educativa', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Seminario II: Transformación de la Práctica Laboral', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN GESTIÓN Y MANTENIMIENTO DEL AMBIENTE ESCOLAR': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (5, 'QUINTO TRIMESTRE', 'Proyecto Práctica Institucional II:B MI Contexto Laboral y la soberania Productiva', 3),
        (5, 'QUINTO TRIMESTRE', 'Educación y Economia Social', 3),
        (5, 'QUINTO TRIMESTRE', 'Cuidado y Mantenimiento de Infraestructuras Educativas', 3),
        (5, 'QUINTO TRIMESTRE', 'Mantenimiento y reparación de mobiliarios y equipos en el contexto laboral', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto Práctica Institucional II:C MI Contexto Laboral y la soberania Productiva', 3),
        (6, 'SEXTO TRIMESTRE', 'Educación en, por y para la Producción', 3),
        (6, 'SEXTO TRIMESTRE', 'Formación profesional en el contexto laboral I', 3),
        (6, 'SEXTO TRIMESTRE', 'Seminario I: Transformación de la práctica laboral', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Psicologia para la transformación de la realidad social', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Manejo de Riesgos Socioambientales en el Contexto Laboral', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Idiomas', 3),
        ...
        (9, 'NOVENO TRIMESTRE', 'Proyecto Práctica Institucional III.C Mi contexto Laboral y la Integración Sociocomunitaria', 3),
        (9, 'NOVENO TRIMESTRE', 'Cultura Institucional', 3),
        (9, 'NOVENO TRIMESTRE', 'Seguridad escolar integral', 3),
        (9, 'NOVENO TRIMESTRE', 'Clima Organizacional: Cultura emancipadora para el Vivir Bien.', 3),
        (10, 'DECIMO TRIMESTRE', 'Proyecto Práctica Institucional IV:. A Sistematizando la Practica Laboral Transformadora en la institucion Educativa', 3),
        (10, 'DECIMO TRIMESTRE', 'Educación Popular', 3),
        (10, 'DECIMO TRIMESTRE', 'Evaluación Institucional', 3),
        ...
        (10, 'DECIMO PRIMER TRIMESTRE', 'Proyecto Práctica Institucional IV. B Sistematizando la Practica Laboral Transformadora en la institucion Educativa', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Trabajo voluntario y Productivo', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Ambiente,Salud y Desarrollo Sustentable y Sostenible', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'La Institución Educativa y la Evaluación del Desempeño', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Proyecto Práctica Institucional IV.C :Sistematizando la Practica Laboral Transformadora en la institucion Educativa', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Comunalización y construcción del Poder Popular', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Formación profesional en el contexto laboral II', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Seminario II: Transformación de la Práctica Laboral', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN EDUCACIÓN DE JÓVENES, ADULTOS Y ADULTAS': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Proyecto Práctica Docente I.A. El Docente y el Contexto Educativo', 3),
        (1, 'PRIMER TRIMESTRE', 'Enfoque Socio Critico', 3),
        (1, 'PRIMER TRIMESTRE', 'El Docente y el Contexto Educativo de la Educación de Jóvenes, Adultos y Adultas', 3),
        (1, 'PRIMER TRIMESTRE', 'Lengua, Cultura y Comunicación', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Proyecto Práctica Docente I:B El Docente y el Contexto Educativo', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Pensamiento Robinsoniano y Transformación Pedagogícas de la practica educativa', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Formación Ciudadana', 3),
        (3, 'TERCER TRIMESTRE', 'Proyecto Práctica Docente I.C El Docente y el Contexto Educativo', 3),
        (3, 'TERCER TRIMESTRE', 'La Descolonización del pensamiento .Una vision critica de la Educacion de Jovenes y adultos', 3),
        (3, 'TERCER TRIMESTRE', 'Enfoques y tendencias de la Educación de jovenes de adultas y adultos', 3),
        (3, 'TERCER TRIMESTRE', 'Educación Crítica de los Medios', 3),
        (4, 'CUARTO TRIMESTRE', 'Proyecto Práctica Docente II.A Mi Práctica Pedagógica y la Soberanía Productiva', 3),
        (4, 'CUARTO TRIMESTRE', 'Dirección y Planificación Educativa en la Educación de Jóvenes, Adultos', 3),
        (4, 'CUARTO TRIMESTRE', 'Pedagogía y Didáctica de los Componentes de la Educación', 3),
        (4, 'CUARTO TRIMESTRE', 'Soberania e identidad Nacional', 3),
        (5, 'QUINTO TRIMESTRE', 'Proyecto Práctica Docente II.B Mi Práctica Pedagógica y Soberania Productiva', 3),
        (5, 'QUINTO TRIMESTRE', 'Educación en, por y para la producción', 3),
        (5, 'QUINTO TRIMESTRE', 'Los Jóvenes, la Población Adulta y sus Necesidades de Aprendizaje', 3),
        (5, 'QUINTO TRIMESTRE', 'Calidad educativa y Gestion Institucional', 3),
        (6, 'SEXTO TRIMESTRE', 'Proyecto Práctica Docente II.C Mi Práctica Pedagógica y Soberania Productiva', 3),
        (6, 'SEXTO TRIMESTRE', 'Pedagogía Productiva', 3),
        (6, 'SEXTO TRIMESTRE', 'Diagnóstico y Caracterización de los Procesos Educativos Grupales', 3),
        (6, 'SEXTO TRIMESTRE', 'Seminario I: Transformación de la Práctica Pedagógica', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Proyecto Práctica Docente III.A Mi Práctica Pedagógica y la soberania Productiva', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Psicologia Educativa para la transformacion de la Educacion de jovenes, adultas y adultos', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Educación Popular para la construcción del Poder Popular', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Idiomas', 3),
        (8, 'OCTAVO TRIMESTRE', 'Proyecto Práctica Docente III.C Mi Práctica Pedagógica y la soberania Productiva', 3),
        (8, 'OCTAVO TRIMESTRE', 'Sociologia Educativa para la transformación de la Educación de jovenes, adultas y adultos', 3),
        (8, 'OCTAVO TRIMESTRE', 'La Actividad Física, Bienestar Personal y Salud Social', 3),
        (9, 'NOVENO TRIMESTRE', 'Proyecto Práctica Docente III.C Mi Práctica Pedagógica y la soberania Productiva', 3),
        (9, 'NOVENO TRIMESTRE', 'Políticas Públicas en Venezuela', 3),
        (9, 'NOVENO TRIMESTRE', 'Clima Escolar: Cultura emancipadora para el vivir bien', 3),
        (10, 'DECIMO TRIMESTRE', 'Proyecto Práctica Docente IV. A Mi Práctica Pedagógica y la soberania productiva', 3),
        (10, 'DECIMO TRIMESTRE', 'Manejo de los riesgos Socio Ambientales', 3),
        (10, 'DECIMO TRIMESTRE', 'La Educación de Jóvenes, Adultas y Adultos y sus necesidades Educativas Especiales', 3),
        (10, 'DECIMO TRIMESTRE', 'Cultura y Tradiciones Venezolanas', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Proyecto Práctica Docente IV:. B Mi Práctica Pedagógica y la soberania productiva', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Trabajo Voluntario y Productivo', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Educación a Distancia, Didáctica y Perspectivas de inclusion', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Medios de Comunicación y las Redes Sociales como agentes del Cambio Social Y Organizativo desde la Educacion', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Proyecto Práctica Docente IV.C Mi Práctica Pedagógica y la soberania productiva', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Seminario II: Transformación de la Práctica Pedagógica', 3),
    ],
    'LICENCIADO/A EN EDUCACIÓN, MENCIÓN EDUCACIÓN ESPECIAL': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (1, 'PRIMER TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica Caracterización del Ámbito Socio comunitario I', 3),
        (1, 'PRIMER TRIMESTRE', 'Sistema Educativo Venezolano', 3),
        (1, 'PRIMER TRIMESTRE', 'Educación Especial', 3),
        (1, 'PRIMER TRIMESTRE', 'Neuroanatomía y Neurofisiología Humana', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica Caracterización del Ámbito Socio comunitario II', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Pedagogía como Ciencia Social', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Desarrollo Humano', 3),
        (2, 'SEGUNDO TRIMESTRE', 'Prevención y Atención Integral Temprana', 3),
        (3, 'TERCER TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica Proyecto: Comunalización de la Educación', 3),
        (3, 'TERCER TRIMESTRE', 'Metodología de La Investigación', 3),
        (3, 'TERCER TRIMESTRE', 'Didáctica para la Discapacidad Cognitiva o Retardo Mental', 3),
        (3, 'TERCER TRIMESTRE', 'Psicología Educativa', 3),
        (4, 'CUARTO TRIMESTRE', 'Práctica Docente para La Transformación Pedagógica Instrumentos, Técnicas y Recolección de Datos', 3),
        (4, 'CUARTO TRIMESTRE', 'Pedagogía del Amor, el Ejemplo y la Curiosidad', 3),
        (4, 'CUARTO TRIMESTRE', 'Estrategias Didácticas para estudiantes con Dificultades de Aprendizaje', 3),
        (4, 'CUARTO TRIMESTRE', 'Educación y Trabajo para La Integración Social', 3),
        (5, 'QUINTO TRIMESTRE', 'Práctica Docente para La Transformación Pedagógica Sistematización de la práctica educativa especializada', 3),
        (5, 'QUINTO TRIMESTRE', 'Pensamiento Pedagógico Liberador Nuestro Americano', 3),
        (5, 'QUINTO TRIMESTRE', 'Caracterización del estudiante con Autismo', 3),
        (5, 'QUINTO TRIMESTRE', 'Inclusión social de estudiantes con necesidades educativas especiales y/o con discapacidad', 3),
        (6, 'SEXTO TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica Investigación –Acción', 3),
        (6, 'SEXTO TRIMESTRE', 'Planificación y Evaluación en el Sistema Escolar', 3),
        (6, 'SEXTO TRIMESTRE', 'Didáctica para la Discapacidad Motora o Impedimentos Físicos', 3),
        (6, 'SEXTO TRIMESTRE', 'Rol de la familia en la atención educativa especializada', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica Registro y análisis de datos', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Escuela, Familia y Comunidad y la inclusión social', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Atención Educativa para Personas Sordas y con Discapacidad Auditiva', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Evaluación en Educación Especial', 3),
        (8, 'OCTAVO TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica Plan de Acción-Ejecución I', 3),
        (8, 'OCTAVO TRIMESTRE', 'Idioma o Lengua extranjera', 3),
        (8, 'OCTAVO TRIMESTRE', 'Atención de Estudiantes con Deficiencias Visuales, o Discapacidad Visual', 3),
        (8, 'OCTAVO TRIMESTRE', 'Planificación en Educación Especial', 3),
        (9, 'NOVENO TRIMESTRE', 'Práctica Docente Para la Transformación Pedagógica Plan de Acción-Ejecución II', 3),
        (9, 'NOVENO TRIMESTRE', 'Uso de las TIC en Educación Especial', 3),
        (9, 'NOVENO TRIMESTRE', 'Atención de estudiantes con Talento o alto desempeño', 3),
        (9, 'NOVENO TRIMESTRE', 'Adaptaciones Curriculares en Educación Especial', 3),
        (10, 'DECIMO TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica Sistematización y Socialización de la Práctica Pedagógica a través de la Investigación Acción Participativa y Transformadora', 3),
        (10, 'DECIMO TRIMESTRE', 'Creatividad e Innovación', 3),
        (10, 'DECIMO TRIMESTRE', 'Procesos Didácticos para la Escritura, Lectura y Matemática', 3),
        (10, 'DECIMO TRIMESTRE', 'Desarrollo y estimulación del lenguaje en la infancia', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica I', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Proceso Social de la Lengua', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Lengua de Señas Venezolana', 3),
        (10, 'DECIMO PRIMER TRIMESTRE', 'Educación integral de la sexualidad', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Práctica Docente para la Transformación Pedagógica II', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'El Docente como Líder Social', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Sistema Braille', 3),
        (10, 'DECIMO SEGUNDO TRIMESTRE', 'Educación Física Adaptada', 3),
    ],
}

# Mallas de los programas TSU (Técnico Superior Universitario) - recorrido corto.
_MALLAS_TSU = {
    'TSU EN EDUCACIÓN, MENCIÓN MATEMÁTICA': [
        (0, '', 'ESTADO (recibió formación presencial o multimodal)', 3),
        (0, '', 'MUNICIPIO (recibió formación presencial o multimodal)', 3),
    ...
    'TSU EN EDUCACIÓN, MENCIÓN FÍSICA': [
        ...
        (0, '', 'Código DEA Institución Educativa', 3),
        (0, '', 'Denominación Institución Educativa', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Proyecto Práctica Docente Transformadora VII', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Seminario: Pensamiento Pedagógico Liberador Nuestroamericano', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Ciencias Naturales para la Transformación Social I', 3),
        (7, 'SEPTIMO TRIMESTRE', 'Laboratorio Procesos Didácticos de la Física I', 3),
        (8, 'OCTAVO TRIMESTRE', 'Proyecto Práctica Docente Transformadora VIII', 3),
...
# Se integran a las mallas oficiales para que el sembrado inicial las cargue.
_MALLAS_OFICIALES.update(_MALLAS_BACHILLER)
_MALLAS_OFICIALES.update(_MALLAS_TSU)
