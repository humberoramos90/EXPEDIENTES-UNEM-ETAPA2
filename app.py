...
# Para el Administrador Regional (Nivel 3): su NOMBRE es el nombre del ESTADO
# que tiene asignado. Solo puede ver y trabajar los registros de ese estado.
estado_regional = nombre_usuario if rol == "ADMIN_REGIONAL" else None
...
# ============================================================
    ...
    if st.session_state.get("_limpiar_registro"):
        for _k in ("reg_estado", "reg_municipio", "reg_tipo_programa",
                   ...
                   "reg_nombres", "reg_apellidos", "reg_cedula", "reg_correo",
    ...
    with st.form("form_registro", clear_on_submit=False):
        ...
        with col_c:
            ...
            cedula = st.text_input("🪪 CÉDULA DE IDENTIDAD *", placeholder="Ej: V-12345678", key="reg_cedula")
...
# ============================================================
    ...
    with tab_crear:
        ...
        if es_regional_nuevo:
            st.caption("El Administrador Regional queda ligado a un ESTADO. Solo podrá ver y "
                       "trabajar los registros de ese estado.")
        ...
        with st.form("form_crear_usuario", clear_on_submit=True):
            ...
            with col1:
                ...
                if es_regional_nuevo:
                    nuevo_nombre = st.selectbox("🏛️ Estado asignado *", list(ESTADOS_MUNICIPIOS.keys()))
                else:
            ...
            if st.form_submit_button("➕ Crear Usuario", use_container_width=True, type="primary"):
                if nuevo_usuario.strip() and nueva_clave.strip() and str(nuevo_nombre).strip():
                    ...
                    st.warning("⚠️ Complete usuario, contraseña y nombre/estado.")
